...
const timeline = [
  ...
  },
  {
    time: '18:00',
    title: 'Ужин и тосты',
    text: 'Неспешный праздник с музыкой, танцами и чудесной атмосферой.',
  },
  {
    time: '23:00',
    title: 'Торт',
      ...
      <section className="location-section">
        <Reveal className="section-card location-card">
          <div className="location-copy">
            ...
            <h2>Времена Года</h2>
            <p>
              Наше торжество пройдет в уютной загородной локации дом-ресторан Времена года. Адрес: Бердск, Улица Зелёная Роща, 10/1
            </p>
            <a
